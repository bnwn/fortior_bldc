...
#define   _IQ_v1   (2<<(GLOBAL_Q-1))  //16777216  wangt 20150225
#define   _IQ_v0_5 (2<<(GLOBAL_Q-2))  //8388608   wangt 20150225
//---------------------------------------------------------------------------
...
#endif
//---------------------------------------------------------------------------
#define  _IQ30toF(A) (A/1073741824.0L)
#define  _IQ29toF(A) (A/536870912.0L)
#define  _IQ28toF(A) (A/268435456.0L)
#define  _IQ27toF(A) (A/134217728.0L)
#define  _IQ26toF(A) (A/67108864.0L)
#define  _IQ25toF(A) (A/33554432.0L)
#define  _IQ24toF(A) (A/16777216.0L)
#define  _IQ23toF(A) (A/8388608.0L)
#define  _IQ22toF(A) (A/4194304.0L)
#define  _IQ21toF(A) (A/2097152.0L)
#define  _IQ20toF(A) (A/1048576.0L)
#define  _IQ19toF(A) (A/524288.0L)
#define  _IQ18toF(A) (A/262144.0L)
#define  _IQ17toF(A) (A/131072.0L)
#define  _IQ16toF(A) (A/65536.0L)
#define  _IQ15toF(A) (A/32767.0L)
//#define  _IQ15toF(A) (A/32768.0L)
#define  _IQ14toF(A) (A/16384.0L)
#define  _IQ13toF(A) (A/8192.0L)
#define  _IQ12toF(A) (A/4096.0L)
#define  _IQ11toF(A) (A/2048.0L)
#define  _IQ10toF(A) (A/1024.0L)
#define  _IQ9toF(A) (A/512.0L)
#define  _IQ8toF(A) (A/256.0L)
#define  _IQ7toF(A) (A/128.0L)
#define  _IQ6toF(A) (A/64.0L)
#define  _IQ5toF(A) (A/32.0L)
#define  _IQ4toF(A) (A/16.0L)
#define  _IQ3toF(A) (A/8.0L)
#define  _IQ2toF(A) (A/4.0L)
#define  _IQ1toF(A) (A/2.0L)
...
//---------------------------------------------------------------------------
#if (GLOBAL_Q<=15)
#define   __IQmpy(A,B,C)   ((A*B)>>C)
#else
#define   __IQmpy(A,B,C)   (((__int64) A*B)>>C)
#endif
...
#define  _IQ30div(A,B) ((A/B)<<30)
#define  _IQ29div(A,B) ((A/B)<<29)
#define  _IQ28div(A,B) ((A/B)<<28)
#define  _IQ27div(A,B) ((A/B)<<27)
#define  _IQ26div(A,B) ((A/B)<<26)
#define  _IQ25div(A,B) ((A/B)<<25)
#define  _IQ24div(A,B) ((A/B)<<24)
#define  _IQ23div(A,B) ((A/B)<<23)
#define  _IQ22div(A,B) ((A/B)<<22)
#define  _IQ21div(A,B) ((A/B)<<21)
#define  _IQ20div(A,B) ((A/B)<<20)
#define  _IQ19div(A,B) ((A/B)<<19)
#define  _IQ18div(A,B) ((A/B)<<18)
#define  _IQ17div(A,B) ((A/B)<<17)
#define  _IQ16div(A,B) ((A/B)<<16)
#define  _IQ15div(A,B) ((A/B)<<15)
#define  _IQ14div(A,B) ((A/B)<<14)
#define  _IQ13div(A,B) ((A/B)<<13)
#define  _IQ12div(A,B) ((A/B)<<12)
#define  _IQ11div(A,B) ((A/B)<<11)
#define  _IQ10div(A,B) ((A/B)<<10)
#define  _IQ9div(A,B) ((A/B)<<9)
#define  _IQ8div(A,B) ((A/B)<<8)
#define  _IQ7div(A,B) ((A/B)<<7)
#define  _IQ6div(A,B) ((A/B)<<6)
#define  _IQ5div(A,B) ((A/B)<<5)
#define  _IQ4div(A,B) ((A/B)<<4)
#define  _IQ3div(A,B) ((A/B)<<3)
#define  _IQ2div(A,B) ((A/B)<<2)
#define  _IQ1div(A,B) ((A/B)<<1)
